...
local library = {
    version = "2.0.2",
    title = title or "jxn " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Watermark(text)
    ...
    edge.BackgroundColor3 = library.Theme.Secondary
    ...
    waterText.Text = text
    waterText.TextColor3 = library.Theme.Text
...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local jxnLogo = Instance.new("ImageLabel")
    local hashIcon = Instance.new("ImageLabel")
    local jxn = Instance.new("TextLabel")
...
-- fix part 2
    ...
    local GradientKey1 = ColorSequenceKeypoint.new(0.00, library.Theme.Background))
    local GradientKey2 = ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt))
    local GradientPoints = { GradientKey1, GradientKey2 }
    local BGSequenceGradient = ColorSequence.new(GradientPoints)
    backgroundGradient.Color = BGSequenceGradient
    ...
    jxnLogo.Name = "jxnLogo"
    jxnLogo.Parent = background
    jxnLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    jxnLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    jxnLogo.BackgroundTransparency = 1.000
    jxnLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    jxnLogo.Size = UDim2.new(0, 448, 0, 150)
    jxnLogo.Visible = true
    jxnLogo.Image = ""
    jxnLogo.ImageColor3 = library.Theme.Accent
    jxnLogo.ImageTransparency = 1
    
    hashIcon.Name = "hashIcon"
    hashIcon.Parent = background
    hashIcon.AnchorPoint = Vector2.new(0.5, 0.5)
    hashIcon.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    hashIcon.BackgroundTransparency = 1.000
    hashIcon.Position = UDim2.new(0.5, 0, 0.5, 0)
    hashIcon.Size = UDim2.new(0, 150, 0, 150)
    hashIcon.Visible = true
    hashIcon.Image = ""
    hashIcon.ImageColor3 = library.Theme.Accent
    hashIcon.ImageTransparency = 1
    
    jxn.Name = "jxn"
    jxn.Parent = background
    jxn.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    jxn.BackgroundTransparency = 1.000
    jxn.Size = UDim2.new(0, 80, 0, 21)
    jxn.Font = Enum.Font.Code
    jxn.Text = "powered by jxn"
    jxn.TextColor3 = Color3.fromRGB(124, 124, 124)
    jxn.TextSize = 10.000
    jxn.TextTransparency = 1
    ...
    wait(.2)
    TweenService:Create(jxn, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(jxnLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(jxnLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    TweenService:Create(hashIcon, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(hashIcon, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.1)
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
    TweenService:Create(jxn, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
...
function library:Init(key)
    ...
    tabButtonsEdge.BackgroundColor3 = library.Theme.Edge
    ...
    tabButtonsGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Background), ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt)}
    ...
    containerEdge.BackgroundColor3 = library.Theme.Edge
    ...
    containerGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Background), ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt)}
...
-- part 3 fix
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            for i,v in pairs(tabButtons:GetChildren()) do
                if v:IsA("TextButton") then
                    TweenService:Create(v, TweenTable["tab_text_colour"], {TextColor3 = library.Theme.TextDark}):Play()
                end
            end
        ...
        function Components:NewButton(text, callback)
            ...
            button.BackgroundColor3 = library.Theme.Edge
            ...
            buttonGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Background), ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt)}
            ...
            buttonLabel.TextColor3 = library.Theme.TextDim
            buttonLabel.TextSize = 14.000
            buttonLabel.RichText = true

            button.MouseEnter:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = library.Theme.Secondary}):Play()
            end)
            button.MouseLeave:Connect(function()
                TweenService:Create(button, TweenTable["hover"], {BackgroundColor3 = library.Theme.Edge}):Play()
            end)
            ...
            button.MouseButton1Up:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = library.Theme.TextDim}):Play()
            end)
...
-- part 4 fix
        ...
        function Components:NewSection(text)
            ...
            rightBar.BackgroundColor3 = library.Theme.Secondary
        ...
        function Components:NewToggle(text, default, callback)
            ...
            toggleButton.Text = ""
            toggleButton.TextColor3 = library.Theme.TextDim
            ...
            toggleEdge.BackgroundColor3 = library.Theme.Edge
            ...
            toggleGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Background), ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt)}
            ...
            toggleLabel.TextColor3 = library.Theme.TextDim
            ...
            toggleButton.MouseLeave:Connect(function()
                TweenService:Create(toggleLabel, TweenTable["hover"], {TextColor3 = library.Theme.TextDim}):Play()
            end)
            ...
            function ToggleFunctions:AddKeybind(default_t)
                ...
                keybind.BackgroundColor3 = library.Theme.Edge
                ...
                keybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Background), ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt)}
                ...
                keybindButtonLabel.TextColor3 = library.Theme.TextDim
...
-- part 6 done
                ...
                textboxTwoGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Background), ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt)}
                ...
                textBoxValues.PlaceholderColor3 = library.Theme.TextPlaceholder
                textBoxValues.PlaceholderText = place
                textBoxValues.Text = ""
                textBoxValues.TextColor3 = library.Theme.TextDim
                ...
                textboxLabel.TextColor3 = library.Theme.TextDim
                ...
                textboxFrame.MouseLeave:Connect(function()
                    TweenService:Create(textboxLabel, TweenTable["TextBox"], {TextColor3 = library.Theme.TextDim}):Play()
                end)

                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = library.Theme.Accent}):Play()
                end)

                textBoxValues.FocusLost:Connect(function()
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = library.Theme.Secondary}):Play()
                end)
...
-- part 8 8888888888888888888888888888888888888888
            ...
            selectorLabel.TextColor3 = library.Theme.TextDim
            ...
            selector.BackgroundColor3 = library.Theme.Secondary
            ...
            selectorTwoGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Background), ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt)}
            ...
            for i,v in next, list do
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = library.Theme.Accent}):Play()
            ...
            function SelectorFunctions:AddOption(new, callback_f)
                ...
                optionButton.TextColor3 = library.Theme.TextPlaceholder
                optionButton.TextSize = 14.000
                if optionButton.Text == default then
                    optionButton.TextColor3 = library.Theme.Accent
                    callback(selectorText.Text)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    for z,x in next, selectorContainer:GetChildren() do
                        if x:IsA("TextButton") then
                            TweenService:Create(x, TweenTable["selector"], {TextColor3 = library.Theme.TextPlaceholder}):Play()
                        end
                    end
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = library.Theme.Accent}):Play()
                    selectorText.Text = optionButton.Text
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderButton.BackgroundColor3 = library.Theme.Secondary
            ...
            sliderBackgroundGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Background), ColorSequenceKeypoint.new(1.00, library.Theme.BackgroundAlt)}
...
-- fix 9
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, library.Theme.Accent), ColorSequenceKeypoint.new(1.00, library.Theme.AccentDark)}
            ...
            sliderLabel.TextColor3 = library.Theme.TextDim
            ...
            sliderValue.TextColor3 = library.Theme.TextPlaceholder
...
--[[
    THEME SYSTEM
    You can change the theme colors dynamically using:
    library:SetThemeColor("Accent", library.Theme.Accent)
]]

library.Theme = {
    Background = library.Theme.Background,
    Accent = library.Theme.Accent,
    Text = library.Theme.Text,
    Secondary = library.Theme.Secondary
}

function library:SetThemeColor(element, color)
    if self.Theme[element] then
        self.Theme[element] = color
        self:ApplyTheme()
    end
end
...
function library:ApplyTheme()
    for _, obj in pairs(game:GetDescendants()) do
        ...
        elseif obj:IsA("Frame") or obj:IsA("ImageLabel") then
            if string.find(obj.Name:lower(), "background") then
                obj.BackgroundColor3 = self.Theme.Background
            elseif string.find(obj.Name:lower(), "bar") then
                obj.BackgroundColor3 = self.Theme.Accent
            elseif string.find(obj.Name:lower(), "edge") then
                obj.BackgroundColor3 = self.Theme.Secondary
            end
        end
    end
end
...
--[[
    ...
    You can call library:SelfDestruct("soft") or library:SelfDestruct("full")
    - "soft": removes all GUI elements safely.
    - "full": removes GUI + clears references + disconnects services.
]]

function library:SelfDestruct(mode)
    mode = mode or "soft"
    ...
    if mode == "full" then
        -- Clear tweens, connections, and references
        pcall(function()
